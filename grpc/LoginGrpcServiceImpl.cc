...
//
//grpc::Status LoginGrpcServiceImpl::registerUser(::grpc::ServerContext *context, const ::grpc_login::UserRequest *request,
...
//}
//
//grpc::Status LoginGrpcServiceImpl::userInfo(::grpc::ServerContext *context, const ::grpc_login::SessionResponse *request,
