...
::grpc::Status LoginGrpcService::Stub::userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc_login::Result* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_userInfo_, context, request, response);
}

void LoginGrpcService::Stub::experimental_async::userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_userInfo_, context, request, response, std::move(f));
}

void LoginGrpcService::Stub::experimental_async::userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_userInfo_, context, request, response, std::move(f));
}

void LoginGrpcService::Stub::experimental_async::userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void LoginGrpcService::Stub::experimental_async::userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_userInfo_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::grpc_login::Result>* LoginGrpcService::Stub::AsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::grpc_login::Result>::Create(channel_.get(), cq, rpcmethod_userInfo_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::grpc_login::Result>* LoginGrpcService::Stub::PrepareAsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::grpc_login::Result>::Create(channel_.get(), cq, rpcmethod_userInfo_, context, request, false);
}
...
::grpc::Status LoginGrpcService::Service::userInfo(::grpc::ServerContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
