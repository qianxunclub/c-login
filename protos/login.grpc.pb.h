 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc_login::Result* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>> AsyncuserInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>>(AsyncuserInfoRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>> PrepareAsyncuserInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>>(PrepareAsyncuserInfoRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      #endif
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)>) = 0;
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>* AsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::grpc_login::Result>* PrepareAsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc_login::Result* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>> AsyncuserInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>>(AsyncuserInfoRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>> PrepareAsyncuserInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>>(PrepareAsyncuserInfoRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)>) override;
      void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void userInfo(::grpc::ClientContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void userInfo(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::grpc_login::Result* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>* AsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::grpc_login::Result>* PrepareAsyncuserInfoRaw(::grpc::ClientContext* context, const ::grpc_login::SessionRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status userInfo(::grpc::ServerContext* context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response);
  ...
  class WithAsyncMethod_userInfo : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status userInfo(::grpc::ServerContext* /*context*/, const ::grpc_login::SessionRequest* /*request*/, ::grpc_login::Result* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestuserInfo(::grpc::ServerContext* context, ::grpc_login::SessionRequest* request, ::grpc::ServerAsyncResponseWriter< ::grpc_login::Result>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
        ...
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc_login::SessionRequest, ::grpc_login::Result>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc_login::SessionRequest* request, ::grpc_login::Result* response) { return this->userInfo(context, request, response); }));}
  ...
  class WithStreamedUnaryMethod_userInfo : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreameduserInfo(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::grpc_login::SessionRequest,::grpc_login::Result>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
